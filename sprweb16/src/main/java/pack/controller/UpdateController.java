...
public class UpdateController {
	...
	@GetMapping("update")
	public String eidt(Model model, @RequestParam("num")int num, @RequestParam("page")String page) {
		//수정 대상 자료 읽기
	...
	@PostMapping("update")
	public String eidtProcess(BoardBean bean, @RequestParam("page")String page, Model model) {
		//비밀번호 비교
